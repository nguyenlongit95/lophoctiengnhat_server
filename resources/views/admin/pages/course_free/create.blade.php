...
@section('content')
    <div class="content-wrapper">
        ...
        <form action="{{ url('/admin/course-free/store') }}" class="form-group" method="POST" enctype="multipart/form-data" id="form-add-course-free">
...
@section('custom-js')
    <script type="text/javascript" src="{{ asset('/js/pages/course/course_free.js') }}"></script>
@endsection
