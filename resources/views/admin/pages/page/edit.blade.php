...
@section('content')
    <div class="content-wrapper">
        ...
        <form action="{{ url('/admin/pages/'. $page->id . '/update') }}" class="form-group" method="POST" enctype="multipart/form-data" id="form-add-pages">
                ...
                <div class="card">
                    ...
                    <div class="card-body" style="display: block;">
                        <div class="form-group">
                            ...
                            <textarea name="info" class="form-control" id="info">{{ $page->info }}</textarea>
                            <label id="info-error" class="text-danger error" for="info"></label>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Nội dung trang</label>
                            <textarea name="content" id="ckeditor" cols="30" rows="10">{{ $page->content }}</textarea>
                        </div>
                    </div>
                    <!-- /.card-footer-->
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body" style="display: block;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="slug" readonly class="form-control" id="slug" value="{{ $page->slug }}">
                        </div>
                        <div class="form-group">
                            ...
                            <select name="menu_id" class="form-control" id="menu_id">
                                @if(!empty($menus))
                                    @foreach ($menus as $menu)
                                        <option @if($menu->id === $page->menu_id) selected @endif value="{{ $menu->id }}">{{ $menu->name }}</option>
                                    @endforeach
                                @endif
                            </select>
                        </div>
