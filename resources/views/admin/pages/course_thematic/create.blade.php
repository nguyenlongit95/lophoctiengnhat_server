...
@section('content')
    <div class="content-wrapper">
        ...
        <form action="{{ url('/admin/course-thematic/store') }}" class="form-group" method="POST" enctype="multipart/form-data" id="form-add-course-level">
                ...
                <div class="card">
                    ...
                    <div class="card-body" style="display: block;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="video_link" class="form-control" id="video_link" placeholder="Đường dẫn tới video">
