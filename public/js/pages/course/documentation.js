...
function renderSlugDocSource(idSource) {
    if (idSource === 0) {
        // Add new source
        $('#add-slug-doc-source').val(changeToSlug($('#add-name-doc-source').val()));
    } else {
        // Edit source
        $('#edit-slug-doc-source-' + idSource).val(changeToSlug($('#edit-name-doc-source-' + idSource).val()));
    }
}
